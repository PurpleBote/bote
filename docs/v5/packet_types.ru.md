...
| `TIME`  | 4 байт     | Дата, когда пакет был сохранён на узле (int32)             |
...
| `TIM1`  | 4 байт    | Время, в которое `KEY1` был добавлен на узел. (int32)                                              |
...
| `TIM2`  | 4 байт    | Время, в которое `KEY2` был добавлен на узел. (int32)                                              |
| ...     | ...       | ...                                                                                                |
...
| `TIMn`  | 4 байт    | Время, в которое `KEYn` был добавлен на узел. (int32)                                              |
...
| `DLEN`  | 2 bytes    | Длина поля `DATA`. При значении 0 - без `Пакета данных`.|
...
Запрос K-узлов, ближайших к переданому DHT-ключу.
